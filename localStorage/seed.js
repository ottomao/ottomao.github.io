...
var KISSY = (function (undefined) {
    ...
    S = {
         ...
         * NOTICE: '20131026103144' will replace with current timestamp when compressing.
         * @private
         * @type {String}
         */
        __BUILD_TIME: '20131026103144',
...
(function (S) {
    ...
    S.mix(Utils, {
        ...
        registerModule: function (runtime, name, fn, config) {
            ...
            var afterRegister = S.Config.afterRegister;
            afterRegister && afterRegister(runtime,name,fn,config);
        },
